$(document).ready(function() {
    ...
    const fetchMedia = async function(type, isPreview) {
        ...
        const map = {
            ...
            tv:       ['https://api.themoviedb.org/3/discover/tv?api_key=' + config.apiKey + '&sort_by=popularity.desc&without_original_language=zh,ko', 'tv'],
            anime:    ['https://api.themoviedb.org/3/discover/tv?api_key=' + config.apiKey + '&with_genres=16&sort_by=first_air_date.desc&with_original_language=ja&vote_average.gte=5&vote_count.gte=5&without_keywords=10121,9706,264386,280003,158718,281741', 'tv'],
            kdrama:   ['https://api.themoviedb.org/3/discover/tv?api_key=' + config.apiKey + '&with_original_language=ko&sort_by=first_air_date.desc&vote_average.gte=5&vote_count.gte=5&without_genres=289844,291807', 'tv'],
            cdrama:   ['https://api.themoviedb.org/3/discover/tv?api_key=' + config.apiKey + '&with_original_language=zh&sort_by=first_air_date.desc&vote_average.gte=5&vote_count.gte=5&without_genres=16,10759,10765,10768&without_keywords=15060,248451,289844,184656,234890,293198,192772', 'tv'],
