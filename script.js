$(document).ready(function() {
    ...
    const fetchMedia = async function(type, isPreview) {
        ...
        const map = {
            ...
            cdrama:   ['https://api.themoviedb.org/3/discover/tv?api_key=' + config.apiKey + '&with_original_language=zh&sort_by=first_air_date.desc&vote_average.gte=7&vote_count.gte=2&without_genres=16,10759,10765,10768&with_keywords=9840&without_keywords=248451,289844,184656,234890,293198,192772', 'tv'],
