$(document).ready(function() {
    ...
    const fetchMedia = async function(type, isPreview) {
        ...
        const map = {
            ...
            kdrama:   ['https://api.themoviedb.org/3/discover/tv?api_key=' + config.apiKey + '&with_original_language=ko&sort_by=first_air_date.desc&vote_average.gte=7&vote_count.gte=2&without_keywords=289844,291807&with_keywords=9840|4265', 'tv'],
